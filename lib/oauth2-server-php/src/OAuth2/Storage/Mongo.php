 ...
 */
class Mongo implements AuthorizationCodeInterface, AccessTokenInterface, ClientCredentialsInterface, UserCredentialsInterface, RefreshTokenInterface, JwtBearerInterface, PublicKeyInterface, OpenIDAuthorizationCodeInterface {
    ...
    public function setAuthorizationCode($code, $client_id, $user_id, $redirect_uri, $expires, $scope = null, $id_token = null) {
        ...
        if ($this->getAuthorizationCode($code)) {
            $this->collection('code_table')->updateOne(
                    array('authorization_code' => $code), array('$set' => array(
                    'client_id' => $client_id,
                    'user_id' => $user_id,
                    'redirect_uri' => $redirect_uri,
                    'expires' => $expires,
    ...
    public function setUser($username, $password, $firstName = null, $lastName = null) {
        if ($this->getUser($username)) {
            $this->collection('user_table')->updateOne(
                    array('username' => $username), array('$set' => array(
                    'password' => $password,
